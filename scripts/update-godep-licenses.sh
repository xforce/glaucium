...
LICENSE_ROOT="${LICENSE_ROOT:-${PROJECT_ROOT}}"
cd "${LICENSE_ROOT}"
...
Options:
1. Check if the upstream repository has a newer version with LICENSE, COPYRIGHT
   and/or COPYING files.
2. Contact the author of the package to ensure there is a LICENSE, COPYRIGHT
   and/or COPYING file present.
3. Do not use this package in Glaucium.
__EOF__
      exit 9
  fi
  cat "${file}"
